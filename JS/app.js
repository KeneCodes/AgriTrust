...
document.getElementById('findCropBtn').addEventListener('click', () => scrollToId('crops'));
document.getElementById('startSellingBtn').addEventListener('click', () => scrollToId('cta'));
document.getElementById('ctaFindCrop').addEventListener('click', () => scrollToId('crops'));
...
/* ---------- Crops Data ---------- */
const crops = [
    { name: 'White Maize', weight: '500kg min', price: '&#8358;85,000/ton', rating: 4.8, reviews: 142, badge: 'Hot', img: 'white_maize.jpg' },
    { name: 'Soybeans', weight: '500kg min', price: '&#8358;120,000/ton', rating: 4.9, reviews: 98, badge: 'New', img: 'soybeans.jpg' },
    { name: 'Brown Beans', weight: '500kg min', price: '&#8358;230,000/ton', rating: 4.7, reviews: 76, badge: 'Popular', img: 'brown_beans.jpg' },
    { name: 'Local Rice', weight: '500kg min', price: '&#8358;340,000/ton', rating: 4.6, reviews: 210, badge: 'Hot', img: 'rice_grains.jpg' },
    { name: 'Yellow Maize', weight: '500kg min', price: '&#8358;78,000/ton', rating: 4.5, reviews: 88, badge: 'Available', img: 'hero_grains.jpg' }
];
